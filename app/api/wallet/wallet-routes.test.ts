...
describe('wallet tx log APIs', () => {
  ...
  it('lists current user tx_log entries', async () => {
    await mockStore.txLogRepo.record({ address: '0xabcdef000000000000000000000000000000c1d3', source: 'news', amount: '0.0003' })
  ...
  it('returns total spend, call count, and last research timestamp', async () => {
    await mockStore.txLogRepo.record({ address: '0xabcdef000000000000000000000000000000c1d3', source: 'sentiment', amount: '0.0001' })
    await mockStore.txLogRepo.record({ address: '0xabcdef000000000000000000000000000000c1d3', source: 'whale-watch', amount: '0.0002' })
    ...
    expect(body).toEqual({
      ...
      totalCalls: 2,
      lastResearchAt: '2026-06-25T00:02:00.000Z',
    })
  })
})
