...
const mockStore = vi.hoisted(() => {
  const records = [
    ...
    },
    {
      id: 'research-3',
      address: '0xabcdef000000000000000000000000000000c1d3',
      topic: 'Funding mixed-version row',
      budgetUsdc: '0.02',
      spentUsdc: '0',
      status: 'funding',
      ...
      preparedAt: new Date('2026-06-25T00:02:00.000Z'),
      fundingExpiresAt: new Date('2026-06-25T00:17:00.000Z'),
      startedAt: null,
      completedAt: null,
    },
  ]
  ...
  it('lists current user research records', async () => {
    ...
    expect(body.researches).toEqual([
      ...
      expect.objectContaining({
        ...
        preparedAt: '2026-06-25T00:02:00.000Z',
        fundingExpiresAt: '2026-06-25T00:17:00.000Z',
        startedAt: null,
      }),
    ])
  })
